...
class GlobalFile:
    ...
    Methods:
        ...
        populate_metric : populates an existing column in the global tracker 
            file
    ...
    def populate_metric(self, operation):
        """Populates an existing metric column in the global tracker file with 
        values returned from the 'operation' function.
